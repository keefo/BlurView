...
//- (NSImage *)blurredSnapshot:(NSImage *)snapshot
//{
//    return [snapshot blurredImageWithRadius:40
//                                 iterations:self.iterations
//                                  tintColor:self.tintColor];
//}
//
//- (NSImage *)snapshotOfUnderlyingView
//{
...
//    
//    __strong NSImage *underlyingView = self.underlyingView;
...
//{
//    NSImage *snapshot = [self snapshotOfUnderlyingView];
//    if (async)
//    {
//        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_LOW, 0), ^{
//            
//            NSImage *blurredImage = [self blurredSnapshot:snapshot];
